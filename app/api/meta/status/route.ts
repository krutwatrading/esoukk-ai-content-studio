...
export async function GET(){
 ...
 const definitions=[
  ...
  {id:"whatsapp",name:"WhatsApp",configured:present(process.env.WHATSAPP_ACCESS_TOKEN)&&present(process.env.WHATSAPP_PHONE_NUMBER_ID)&&present(process.env.WHATSAPP_BUSINESS_ACCOUNT_ID)&&encryptionKey,callbackUrl:`${site}/api/whatsapp/webhook`,keys:["WHATSAPP_ACCESS_TOKEN","WHATSAPP_PHONE_NUMBER_ID","WHATSAPP_BUSINESS_ACCOUNT_ID","WHATSAPP_WEBHOOK_VERIFY_TOKEN","SOCIAL_TOKEN_ENCRYPTION_KEY"]},
